...
public class RegistryUtils {
    ...
    public static void initPuttyDefaultSettings() {
        setRegistry("HKCU\\Software\\SimonTatham\\PuTTY\\Sessions\\Default%20Settings", "WarnOnClose", "REG_DWORD", "0");
        setRegistry("HKCU\\Software\\SimonTatham\\PuTTY\\Sessions\\Default%20Settings", "LineCodePage", "REG_SZ", "UTF-8");
        setRegistry("HKCU\\Software\\SimonTatham\\PuTTY\\Sessions\\Default%20Settings", "ScrollbackLines", "REG_DWORD", "5000");
        setRegistry("HKCU\\Software\\SimonTatham\\PuTTY\\Sessions\\Default%20Settings", "WinTitle", "REG_SZ", " ");
        setRegistry("HKCU\\Software\\SimonTatham\\PuTTY\\Sessions\\Default%20Settings", "NoRemoteWinTitle", "REG_DWORD", "1");
    ...
    public static HashMap<String, Object> readPuttyDefaultSettings() {
        ...
        ret.put("WarnOnClose", readRegistry("HKCU\\Software\\SimonTatham\\PuTTY\\Sessions\\Default%20Settings", "WarnOnClose"));
        ret.put("LineCodePage", readRegistry("HKCU\\Software\\SimonTatham\\PuTTY\\Sessions\\Default%20Settings", "LineCodePage"));
        ret.put("ScrollbackLines", readRegistry("HKCU\\Software\\SimonTatham\\PuTTY\\Sessions\\Default%20Settings", "ScrollbackLines"));
        ret.put("WinTitle", readRegistry("HKCU\\Software\\SimonTatham\\PuTTY\\Sessions\\Default%20Settings", "WinTitle"));
        ret.put("NoRemoteWinTitle", readRegistry("HKCU\\Software\\SimonTatham\\PuTTY\\Sessions\\Default%20Settings", "NoRemoteWinTitle"));
        ret.put("BlinkCur", readRegistry("HKCU\\Software\\SimonTatham\\PuTTY\\Sessions\\Default%20Settings", "BlinkCur"));
        return ret;
    }
    ...
    public static List<String> getAllPuttySessions() {
        ...
        for (String location : locations) {
            ...
            if (!"Default%20Settings".equals(name) && !name.isEmpty()) {
                list.add(name);
            }
        }
        return list;
